...
from ttkbootstrap import Button,Label,INFO
...
class HomeFrame(Frame):
    def __init__(self, window, main_view):
        ...
        self.header = Label(self,bootstyle=INFO)
        ...
        self.user_management_button = Button(self, text="User Management", command=self.go_to_usermanagement,bootstyle=INFO)
        self.user_management_button.grid(row=2, column=0, pady=(0, 10), padx=10, sticky="e")

        self.current_user = None

    @performance_logger_decorator("HomeFrame")
